...
public class BalanceConfigHandler {
    ...
    public static final int wyvernToolsMinDigDepthUpgradePoints = 1;
    public static final int wyvernToolsMaxDigDepthUpgradePoints = 5;
    ...
    public static int wyvernArmorMaxTransfer = '썐';
    ...
    public static int wyvernToolsMaxTransfer = '썐';
    ...
    public static int wyvernWeaponsMaxTransfer = '썐';
    ...
    private static void syncConfig() {
        ...
        wyvernArmorMaxCapacityUpgradePoints = (int)Math.floor((double)(Integer.MAX_VALUE - wyvernArmorBaseStorage) / (double)Math.max(wyvernArmorStoragePerUpgrade, 1)) * IUpgradableItem.EnumUpgrade.RF_CAPACITY.pointConversion;
        ...
        draconicArmorMaxCapacityUpgradePoints = (int)Math.floor((double)(Integer.MAX_VALUE - draconicArmorBaseStorage) / (double)Math.max(draconicArmorStoragePerUpgrade, 1)) * IUpgradableItem.EnumUpgrade.RF_CAPACITY.pointConversion;
        ...
        wyvernToolsMaxCapacityUpgradePoints = (int)Math.floor((double)(Integer.MAX_VALUE - wyvernToolsBaseStorage) / (double)Math.max(wyvernToolsStoragePerUpgrade, 1)) * IUpgradableItem.EnumUpgrade.RF_CAPACITY.pointConversion;
        wyvernToolsMaxUpgrades = getInteger("tweaks.tools", "Wyvern Tools: Maximum amount of upgrades", wyvernToolsMaxUpgrades, 0, 1 * IUpgradableItem.EnumUpgrade.DIG_AOE.pointConversion + 12 * IUpgradableItem.EnumUpgrade.DIG_SPEED.pointConversion + 4 * IUpgradableItem.EnumUpgrade.DIG_DEPTH.pointConversion + wyvernToolsMaxCapacityUpgradePoints);
        ...
        draconicToolsMaxCapacityUpgradePoints = (int)Math.floor((double)(Integer.MAX_VALUE - draconicToolsBaseStorage) / (double)Math.max(draconicToolsStoragePerUpgrade, 1)) * IUpgradableItem.EnumUpgrade.RF_CAPACITY.pointConversion;
        draconicToolsMaxUpgrades = getInteger("tweaks.tools", "Draconic Tools: Maximum amount of upgrades", draconicToolsMaxUpgrades, 0, 2 * IUpgradableItem.EnumUpgrade.DIG_AOE.pointConversion + 27 * IUpgradableItem.EnumUpgrade.DIG_SPEED.pointConversion + 4 * IUpgradableItem.EnumUpgrade.DIG_DEPTH.pointConversion + draconicToolsMaxCapacityUpgradePoints);
        ...
        wyvernWeaponsMaxCapacityUpgradePoints = (int)Math.floor((double)(Integer.MAX_VALUE - wyvernWeaponsBaseStorage) / (double)Math.max(wyvernWeaponsStoragePerUpgrade, 1)) * IUpgradableItem.EnumUpgrade.RF_CAPACITY.pointConversion;
        wyvernWeaponsMaxUpgrades = getInteger("tweaks.weapons", "Wyvern Weapons: Maximum amount of upgrades", wyvernWeaponsMaxUpgrades, 0, 2 * IUpgradableItem.EnumUpgrade.ATTACK_AOE.pointConversion + 8 * IUpgradableItem.EnumUpgrade.ATTACK_DAMAGE.pointConversion + wyvernWeaponsMaxCapacityUpgradePoints);
        ...
        draconicWeaponsMaxCapacityUpgradePoints = (int)Math.floor((double)(Integer.MAX_VALUE - draconicWeaponsBaseStorage) / (double)Math.max(draconicWeaponsStoragePerUpgrade, 1)) * IUpgradableItem.EnumUpgrade.RF_CAPACITY.pointConversion;
        draconicWeaponsMaxUpgrades = getInteger("tweaks.weapons", "Draconic Weapons: Maximum amount of upgrades", draconicWeaponsMaxUpgrades, 0, 3 * IUpgradableItem.EnumUpgrade.ATTACK_AOE.pointConversion + 16 * IUpgradableItem.EnumUpgrade.ARROW_DAMAGE.pointConversion + draconicWeaponsMaxCapacityUpgradePoints);
        ...
        wyvernBowMaxCapacityUpgradePoints = (int)Math.floor((double)(Integer.MAX_VALUE - wyvernWeaponsBaseStorage) / (double)Math.max(wyvernWeaponsStoragePerUpgrade, 1)) * IUpgradableItem.EnumUpgrade.RF_CAPACITY.pointConversion;
        wyvernBowMaxUpgrades = getInteger("tweaks.weapons", "Wyvern Bow: Maximum amount of upgrades", wyvernBowMaxUpgrades, 0, 2 * IUpgradableItem.EnumUpgrade.DRAW_SPEED.pointConversion + 9 * IUpgradableItem.EnumUpgrade.ARROW_SPEED.pointConversion + 8 * IUpgradableItem.EnumUpgrade.ARROW_DAMAGE.pointConversion + wyvernBowMaxCapacityUpgradePoints);
        ...
        draconicBowMaxCapacityUpgradePoints = (int)Math.floor((double)(Integer.MAX_VALUE - draconicWeaponsBaseStorage) / (double)Math.max(draconicWeaponsStoragePerUpgrade, 1)) * IUpgradableItem.EnumUpgrade.RF_CAPACITY.pointConversion;
        draconicBowMaxUpgrades = getInteger("tweaks.weapons", "Draconic Bow: Maximum amount of upgrades", draconicBowMaxUpgrades, 0, 2 * IUpgradableItem.EnumUpgrade.DRAW_SPEED.pointConversion + 7 * IUpgradableItem.EnumUpgrade.ARROW_SPEED.pointConversion + 17 * IUpgradableItem.EnumUpgrade.ARROW_DAMAGE.pointConversion + draconicBowMaxCapacityUpgradePoints);
        ...
        draconicStaffMaxCapacityUpgradePoints = (int)Math.floor((double)(Integer.MAX_VALUE - draconicToolsBaseStorage * 2 - draconicWeaponsBaseStorage) / (double)Math.max(draconicToolsStoragePerUpgrade + draconicWeaponsStoragePerUpgrade, 1)) * IUpgradableItem.EnumUpgrade.RF_CAPACITY.pointConversion;
        ...
        wyvernCapacitorMaxCapacityUpgradePoints = (int)Math.floor((double)(Integer.MAX_VALUE - wyvernCapacitorBaseStorage) / (double)Math.max(wyvernCapacitorStoragePerUpgrade, 1)) * IUpgradableItem.EnumUpgrade.RF_CAPACITY.pointConversion;
        ...
        draconicCapacitorMaxCapacityUpgradePoints = (int)Math.floor((double)(Integer.MAX_VALUE - draconicCapacitorBaseStorage) / (double)Math.max(draconicCapacitorStoragePerUpgrade, 1)) * IUpgradableItem.EnumUpgrade.RF_CAPACITY.pointConversion;
    ...
    private static long getLong(String category, String propertyName, long defaultValue) {
        return (long)config.get(category, propertyName, (double)defaultValue, "", 0.0D, 9.223372036854776E18D).getDouble((double)defaultValue);
    }
}
