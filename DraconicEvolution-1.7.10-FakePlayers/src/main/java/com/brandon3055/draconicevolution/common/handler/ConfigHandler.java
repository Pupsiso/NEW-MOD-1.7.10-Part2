...
public class ConfigHandler
{
	...
	public static void syncConfig()
	{
		...
		try
		{
			...
			reactorFuelUsageMultiplier = config.get("Draconic Reactor", "FuelUsageMultiplier", 1D, "Use this to adjust how quickly the reactor uses fuel", 0, 1000000).getDouble(1);
			reactorOutputMultiplier = config.get("Draconic Reactor", "EnergyOutputMultiplier", 1D, "Use this to adjust the output of the reactor", 0, 1000000).getDouble(1);
