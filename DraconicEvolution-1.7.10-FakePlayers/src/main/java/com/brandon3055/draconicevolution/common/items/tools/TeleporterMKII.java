...
public class TeleporterMKII extends TeleporterMKI implements IHudDisplayItem
{
	...
	public boolean onLeftClickEntity(ItemStack stack, EntityPlayer player, Entity entity)
	{
		...
		if (loc == null)
		{
			if (world.isRemote)
				...
				player.openGui(DraconicEvolution.instance, GuiHandler.GUIID_TELEPORTER, world, (int) player.posX, (int) player.posY, (int) player.posZ);
			return true;
		}
		...
		if (entity instanceof EntityPlayer)
		{
			if (entity.isSneaking())
			{
				...
				if (EventConfig.teleporterSelfOnly && player != entity)
					return true;
	...
	public List<String> getDisplayData(ItemStack stack)
	{
		...
		TeleportLocation location = this.getLocation(stack);
		if (location != null)
		{
