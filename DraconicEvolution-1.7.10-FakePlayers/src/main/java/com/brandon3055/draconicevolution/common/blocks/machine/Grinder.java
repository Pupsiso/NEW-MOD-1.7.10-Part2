...
public class Grinder extends BlockCustomDrop
{
	...
	{
		this.icon_front = iconRegister.registerIcon(References.RESOURCESPREFIX + "animated/grinder_front_active");
		this.icon_front_inactive = iconRegister.registerIcon(References.RESOURCESPREFIX + "grinder_front");
	...
	public boolean onBlockActivated(World world, int X, int Y, int Z, EntityPlayer player, int side, float prx, float pry, float prz)
	{
		...
		if (!world.isRemote && !player.isSneaking())
			...
			player.openGui(DraconicEvolution.instance, GuiHandler.GUIID_GRINDER, world, X, Y, Z);
