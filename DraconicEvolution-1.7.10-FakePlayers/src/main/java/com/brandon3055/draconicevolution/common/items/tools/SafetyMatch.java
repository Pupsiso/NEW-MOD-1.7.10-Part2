...
public class SafetyMatch extends ItemDE
{
	...
	public String getUnlocalizedName(ItemStack itemStack)
	{
		if (itemStack.getItemDamage() == 1000)
			...
			return super.getUnlocalizedName(itemStack) + "Box";
	}
	...
	{
		this.itemIcon = iconRegister.registerIcon(References.RESOURCESPREFIX + "safety_match");
		this.boxIcon = iconRegister.registerIcon(References.RESOURCESPREFIX + "box_of_matches");
	}
	...
	{
		return damage == 1000 ? this.itemIcon : this.boxIcon;
	}
