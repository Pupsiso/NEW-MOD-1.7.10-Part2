...
public class EnergyStorageCore extends BlockDE implements IHudDisplayBlock
{
	...
	public void onBlockPlacedBy(World world, int x, int y, int z, EntityLivingBase placer, ItemStack stack)
	{
		...
		TileEntity tile;
		if (placer instanceof EntityPlayer && (tile = world.getTileEntity(x, y, z)) instanceof TileEnergyStorageCore)
			((TileEnergyStorageCore) tile).fake.setProfile(((EntityPlayer) placer).getGameProfile());
	}
	...
	{
		this.blockIcon = iconRegister.registerIcon(References.RESOURCESPREFIX + "energy_storage_core");
	}
