...
public class EntityAyeraco extends EntityDivineRPGBoss
{
	...
	protected void updateAITasks()
	{
		...
		if (this.worldObj.getClosestVulnerablePlayerToEntity(this, 128) != null)
			this.setAttackTarget(this.worldObj.getClosestVulnerablePlayerToEntity(this, 128));
	...
	{
		return this.getHealth() * 2 <= this.getMaxHealth() && !this.isDead;
	}
