							...
							for (var25 = 0; var25 < 3; ++var25)
							{
								for (var26 = 0; var26 < 4; ++var26)
								{
									for (var27 = -1; var27 < 4; ++var27)
									{
										...
										if (var27 < 0 ? !this.myWorld.getBlock(var28, var29, var30).getMaterial().isSolid() : !this.myWorld.isAirBlock(var28, var29, var30))
											continue label178;
									}
								}
							}
							...
							for (var22 = var14; var22 < var14 + 2; ++var22)
							{
								...
								for (var25 = 0; var25 < 4; ++var25)
								{
									for (var26 = -1; var26 < 4; ++var26)
									{
										...
										if (var26 < 0 ? !this.myWorld.getBlock(var27, var28, var29).getMaterial().isSolid() : !this.myWorld.isAirBlock(var27, var28, var29))
											continue label126;
									}
								}
