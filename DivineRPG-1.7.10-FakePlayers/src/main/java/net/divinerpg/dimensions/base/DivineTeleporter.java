							...
							for (i4 = 0; i4 < 3; ++i4)
							{
								for (j4 = 0; j4 < 4; ++j4)
								{
									for (k4 = -1; k4 < 4; ++k4)
									{
										...
										if (k4 < 0 ? !this.worldServerInstance.getBlock(l4, i5, j5).getMaterial().isSolid() : !this.worldServerInstance.isAirBlock(l4, i5, j5))
											continue label274;
									}
								}
							}
							...
							for (j3 = l1; j3 < l1 + 2; ++j3)
							{
								...
								for (i4 = 0; i4 < 4; ++i4)
								{
									for (j4 = -1; j4 < 4; ++j4)
									{
										...
										if (j4 < 0 ? !this.worldServerInstance.getBlock(k4, l4, i5).getMaterial().isSolid() : !this.worldServerInstance.isAirBlock(k4, l4, i5))
											continue label222;
									}
								}
