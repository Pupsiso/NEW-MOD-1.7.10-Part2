...
public class ItemMeteorMash extends ItemMod
{
	...
	public ItemStack onItemRightClick(ItemStack stack, World world, EntityPlayer player)
	{
		...
		double y = player.posY + 1.62D - player.yOffset;
		...
		Vec3 worldVector2 = worldVector.addVector(xVec * multiplyer, yVec * multiplyer, zVec * multiplyer);
		...
		if (objPos.typeOfHit == MovingObjectType.BLOCK)
		{
			...
			{
				// TODO gamerforEA code replace, old code: world.spawnEntityInWorld(new EntityMeteor(world, blockX + 0.5D, blockY + 25D, blockZ + 0.5D));
				EntityMeteor meteor = new EntityMeteor(world, blockX + 0.5D, blockY + 25D, blockZ + 0.5D);
				meteor.fake.setRealPlayer(player);
