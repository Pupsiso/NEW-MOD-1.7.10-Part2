...
public class EntityEvernightProjectile extends EntityThrowableByPlayer
{
	public int damage;
	...
	protected void onImpact(MovingObjectPosition mop)
	{
		...
		{
			mop.entityHit.attackEntityFrom(DamageSource.causeThrownDamage(this, this.thrower), this.damage);
