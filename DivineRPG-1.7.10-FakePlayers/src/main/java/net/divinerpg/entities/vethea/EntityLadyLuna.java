...
public class EntityLadyLuna extends EntityDivineRPGBoss
{
	...
	public void onLivingUpdate()
	{
		...
		{
			// TODO gamerforEA code start
			if (!EventUtils.cantBreak(ModUtils.getModFake(this.worldObj), (int) Math.round(this.posX) - 1, MathHelper.floor_double(this.posY), (int) Math.round(this.posZ) - 1))
			// TODO gamerforEA code end
			{
				...
				if (!this.acidPositions.contains(Util.newChunkCoordinates((int) Math.round(this.posX) - 1, MathHelper.floor_double(this.posY), (int) Math.round(this.posZ) - 1)))
					this.acidPositions.add(Util.newChunkCoordinates((int) Math.round(this.posX) - 1, MathHelper.floor_double(this.posY), (int) Math.round(this.posZ) - 1));
			}
		}
