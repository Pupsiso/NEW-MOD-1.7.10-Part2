...
public class ConduitUtil
{
	...
	public static <T extends IConduit> void disconectConduits(T con, ForgeDirection connDir)
	{
		...
		//this should have been destroyed when destroying the neighbours network but lets just make sure
	...
	public static IConduit readConduitFromNBT(NBTTagCompound conduitRoot, short nbtVersion)
	{
		...
		if (typeName == null || conduitBody == null)
			return null;
		if (typeName.contains("conduit.oc") && !OCUtil.isOCEnabled() || typeName.contains("conduit.me") && !MEUtil.isMEEnabled() || typeName.contains("conduit.gas") && !GasUtil.isGasConduitEnabled())
			return null;
