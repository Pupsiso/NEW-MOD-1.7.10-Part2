...
public class BlockHyperCube extends BlockEio implements IGuiHandler, IResourceTooltipProvider
{
	...
	public void onBlockAdded(World world, int x, int y, int z)
	{
		...
		TileHyperCube tile = (TileHyperCube) world.getTileEntity(x, y, z);
		tile.onBlockAdded(); */
		TileEntity tile = world.getTileEntity(x, y, z);
		if (tile instanceof TileHyperCube)
			((TileHyperCube) tile).onBlockAdded();
	...
	public void onNeighborBlockChange(World world, int x, int y, int z, Block blockId)
	{
		...
		TileEntity tile = world.getTileEntity(x, y, z);
		if (tile instanceof TileHyperCube)
			((TileHyperCube) tile).onNeighborBlockChange();
		// TODO gamerforEA code end
	}
	...
	public boolean removedByPlayer(World world, EntityPlayer player, int x, int y, int z)
	{
		if (!world.isRemote)
		{
			...
			if (tile instanceof TileHyperCube)
			{
				TileHyperCube hc = (TileHyperCube) tile;
				hc.onBreakBlock();
	...
	public void onBlockPlacedBy(World world, int x, int y, int z, EntityLivingBase player, ItemStack stack)
	{
		...
		if (tile instanceof TileHyperCube)
		{
			TileHyperCube cb = (TileHyperCube) tile;
