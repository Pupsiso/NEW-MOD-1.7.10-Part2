...
public class EntityUtil
{
	...
	public static EntityFireworkRocket getRandomFirework(World world, BlockCoord pos)
	{
		...
		return new EntityFireworkRocket(world, pos.x + 0.5, pos.y + 0.5, pos.z + 0.5, firework);
	}
	...
	public static void spawnFirework(BlockCoord block, int dimID, int range)
	{
		...
		if (range > 0)
		{
			...
			if (!blockAtPos.isAir(world, pos.x, pos.y, pos.z) && !blockAtPos.isReplaceable(world, pos.x, pos.y, pos.z))
				return;
			// TODO gamerforEA code end
		}
